...
if len(sys.argv) < 11:
	print("usage: python3 graph_generator.py number_of_grpahs"
		...
		+ "\n" + "node_distribution_in_levels={0/linear,1/exponential} will_graph_size_change(0/1) cost/no_cost"
...
will_graph_size_change = int(sys.argv[9])
for i in range(size):
	if will_graph_size_change == 1:
	...
	for e in edges:
		...
		edge_costs.append(random.randint(1,10))
		if class_of_graph!=3:
			if sys.argv[10] == 'no_cost':
				print(str(e[0]+1)+" "+str(e[1]+1)+" "+str(edge_weights[ei]))
			elif sys.argv[10] == 'cost':
				print(str(e[0]+1)+" "+str(e[1]+1)+" "+str(edge_weights[ei])+" "+str(edge_costs[ei]))
			ei = ei + 1
		else:
			x1, y1 = pos[e[0]]
			x2, y2 = pos[e[1]]
			if sys.argv[10] == 'no_cost':
				...
				print(str(e[0]+1)+" "+str(e[1]+1)+" "+str(math.pow((x1-x2)**2+(y1-y2)**2,.5))+" "+str(edge_costs[ei]))
	print(str(levels))
	...
	for e in edges:
		if class_of_graph!=3:
			if sys.argv[10] == 'no_cost':
				file.write(str(e[0]+1)+" "+str(e[1]+1)+" "+str(edge_weights[ei])+"\n")
			elif sys.argv[10] == 'cost':
				file.write(str(e[0]+1)+" "+str(e[1]+1)+" "+str(edge_weights[ei])+" "+str(edge_costs[ei])+"\n")
			ei = ei + 1
		else:
			x1, y1 = pos[e[0]]
			x2, y2 = pos[e[1]]
			if sys.argv[10] == 'no_cost':
				...
				file.write(str(e[0]+1)+" "+str(e[1]+1)+" "+str(math.pow((x1-x2)**2+(y1-y2)**2,.5))+" "+str(edge_costs[ei])+"\n")
	...
	for e in edges:
		if class_of_graph!=3:
			if sys.argv[10] == 'no_cost':
				print(str(e[0])+" "+str(e[1])+" "+str(edge_weights[ei]))
			elif sys.argv[10] == 'cost':
				print(str(e[0])+" "+str(e[1])+" "+str(edge_weights[ei])+" "+str(edge_costs[ei]))
			ei = ei + 1
		else:
			x1, y1 = pos[e[0]]
			x2, y2 = pos[e[1]]
			if sys.argv[10] == 'no_cost':
				...
				print(str(e[0])+" "+str(e[1])+" "+str(math.pow((x1-x2)**2+(y1-y2)**2,.5))+" "+str(edge_costs[ei]))
	...
	for e in edges:
		if class_of_graph!=3:
			if sys.argv[10] == 'no_cost':
				file.write(str(e[0])+" "+str(e[1])+" "+str(edge_weights[ei])+"\n")
			elif sys.argv[10] == 'cost':
				file.write(str(e[0])+" "+str(e[1])+" "+str(edge_weights[ei])+" "+str(edge_costs[ei])+"\n")
			ei = ei + 1
		else:
			x1, y1 = pos[e[0]]
			x2, y2 = pos[e[1]]
			if sys.argv[10] == 'no_cost':
				...
				file.write(str(e[0])+" "+str(e[1])+" "+str(math.pow((x1-x2)**2+(y1-y2)**2,.5))+" "+str(edge_costs[ei])+"\n")
	file.close()